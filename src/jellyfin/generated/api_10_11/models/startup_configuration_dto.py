...
class StartupConfigurationDto(BaseModel):
    ...
    """ # noqa: E501
    server_name: Optional[StrictStr] = Field(default=None, description="Gets or sets the server name.", alias="ServerName")
    ...
    __properties: ClassVar[List[str]] = ["ServerName", "UICulture", "MetadataCountryCode", "PreferredMetadataLanguage"]

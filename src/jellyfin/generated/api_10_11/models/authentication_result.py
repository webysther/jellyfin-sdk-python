...
class AuthenticationResult(BaseModel):
    ...
    """ # noqa: E501
    user: Optional[UserDto] = Field(default=None, description="Class UserDto.", alias="User")
    session_info: Optional[SessionInfoDto] = Field(default=None, description="Session info DTO.", alias="SessionInfo")

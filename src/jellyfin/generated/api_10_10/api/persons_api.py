...
class PersonsApi:
    ...
    def get_persons(
        ...
        appears_in_item_id: Annotated[Optional[UUID], Field(description="Optional. If specified, person results will be filtered on items related to said persons.")] = None,
